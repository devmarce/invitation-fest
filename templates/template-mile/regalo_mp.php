...
<div class="container" style="margin-top: 10rem;">
    <div class="card bg-none b-none">
        <img src="./templates/template-mile/img/regalo.png" class="card-img-top w-50 m-auto" alt="...">
        <div class="card-body text-center" style="color: #fff;">
            ...
            <p id="alias-mpx" style="display: none;"><?php echo $alias_mile; ?></p>

            <hr>
            <p class="card-text">
            Tu presencia es el mejor regalo para mí. No te preocupes si no sabes que regalarme. En el salón habrá una Urna y sobres para que puedas dejarme un presente. También dejo otra opción, mi Alias: <span style="font-size: 1.2rem; color: #03e9f4; font-weight: 600;">"Mis15mile"</span>.<br><span class="font-keyla-cursiva" style="font-size: 1.5rem;
">¡ Gracias por acompañarme en esta noche tan importante para mí !
    ...
    -webkit-box-reflect: below 1px linear-gradient(transparent, #0005);">Copiar Alias de Mile</button>
                ...
                <div class="modal-dialog">
                    <div class="modal-content text-center" style="background: #fff; color: #000;">
                        <div class="modal-header d-block" style="background: #009ee3; color: #fff">
                            <h1 class="modal-title fs-5 text-center" id="exampleModalLabel">Alias de Mile copiado!</h1>
                        ...
                        <div class="modal-body" style="text-align: center;">
                            ...
                            <hr>
                            <img src="./templates/template-mile/img/transferir.jpg" class="card-img-top" alt="...">
                            <hr>
                            <img src="./templates/template-mile/img/transf-mile.jpg" class="card-img-top" alt="...">
                            <hr>
                            <p>y listo! <br><span class="font-keyla-cursiva" style="font-size: 2rem;">muchas gracias🫶</span></p>
                            <img src="./templates/template-mile/img/flecha-abajo.png" class="card-img-top latido" style="width: 10%;">
                            <br>
                        </div>
