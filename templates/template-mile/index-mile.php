...
<!doctype html>
<html lang="es">
    <?php include './templates/template-mile/componentes/head.php'; ?>
...
<body style="background: #000;">
    ...
    ?>
    <?php if ($tormenta) : ?>
        <video class="video-rayos" src="<?php echo VIDEO_RAYOS; ?>" autoplay="true" muted="true" loop="true" poster="./templates/template-mile/img/mile-metal.jpg"></video>
    <?php endif; ?>
    <main>
        ...
        <div class="container pt-2">
            <div style="font-size: 0.7rem;"><hr><p class="text-center" style="color: #fff">Creado por <a href="https://landingweb.com.ar/" target="_blank" style="text-decoration: none;">Landing Web <img src="./templates/template-mile/img/logo-negro.jpg" style="width: 20px;"></a></p></div>
        </div>
