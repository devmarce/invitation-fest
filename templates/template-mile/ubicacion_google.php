        ...
        <div class="card card-body bg-none b-none" style="color:#fff; padding: 0px;">
            <div class="card bg-none b-none">
                <div class="card-body" style="color:#fff">
                    ...
                    <a class="btn btn-primary" href="<?php echo $link_google; ?>" target="_blank" role="button" style="width: 50%;">ir a Google Map <img src="./templates/template-mile/img/google-map.png" style="width: 10%;"></a>
                    ...
                    <div class="card bg-none border-card-info-salon">
                        <div class="collapse collapse-horizontal bg-none b-none" id="collapse-info-salon">
                            <div class="card card-body bg-none b-none">
                                <!-- card info salón -->
                                <div class="card">
                                    <img src="./templates/template-mile/img/salon.jpg" class="card-img-top" alt="...">
