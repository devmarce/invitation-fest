...
<div class="card text-center mt-5 b-none">
  <div class="card-body position-relative p-0">
    <!-- Video de fondo -->
    <video class="background-video-ageradecimientos" src="./templates/template-mile/img/pasarela-estrellas.mp4" autoplay muted loop playsinline poster="./templates/template-mile/img/mile-metal.jpg"></video>
